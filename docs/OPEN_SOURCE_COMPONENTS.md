...
| ClamAV | https://github.com/Cisco-Talos/clamav | GPL-2.0 | Disposable document malware scanning service | Evaluated 2026-08-20 | Accepted for controlled staging | Official image behind a repository-owned provider-neutral TCP adapter; exact clean/infected/error/timeout/unavailable outcomes are persisted as bounded operational evidence; no raw payloads or provider-specific semantics enter scientific services | 1.4.6 / image digest pinned in Compose |
