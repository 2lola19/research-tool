...
from backend.app.api.routes.ai_certainty import router as ai_certainty_router
from backend.app.api.routes.ai_copilot import router as ai_copilot_router
...
def build_api_router(api_prefix: str) -> APIRouter:
    ...
    router.include_router(ai_certainty_router, prefix=api_prefix)
    router.include_router(ai_copilot_router, prefix=api_prefix)
